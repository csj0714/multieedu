...
public class EmployeeJoinJobsVO {
	...
	public EmployeeJoinJobsVO() {
		super();
	}

	public EmployeeJoinJobsVO(int employee_id, String first_name, String last_name, String email, String phone_number,
			String hire_date, String job_id, int salary, double commission_pct, int manager_id, String job_title) {
		super();
	...
	@Override
	public int hashCode() {
		return Objects.hash(commission_pct, email, employee_id, first_name, hire_date, job_id, job_title, last_name,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EmployeeJoinJobsVO other = (EmployeeJoinJobsVO) obj;
	...
	public String toString() {
		return "EmployeeJoinJobsVO [employee_id=" + employee_id + ", first_name=" + first_name + ", last_name="
				...
				+ manager_id + ", job_title=" + job_title + "]";
	}
