...
public class EmployeeJoinDepartmentJoinJobVO {
	...
	public EmployeeJoinDepartmentJoinJobVO() {
		// TODO Auto-generated constructor stub
	}

	public EmployeeJoinDepartmentJoinJobVO(int employee_id, String first_name, String last_name, String email,
			String phone_number, String hire_date, String job_id, int salary, double commission_pct, int manager_id,
			int department_id, String department_name, String job_title) {
		super();
	...
	public int hashCode() {
		return Objects.hash(commission_pct, department_id, department_name, email, employee_id, first_name, hire_date,
				job_id, job_title, last_name, manager_id, phone_number, salary);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EmployeeJoinDepartmentJoinJobVO other = (EmployeeJoinDepartmentJoinJobVO) obj;
	...
	public String toString() {
		return "EmployeeJoinDepartmentJoinJobVO [employee_id=" + employee_id + ", first_name=" + first_name
				...
				+ ", manager_id=" + manager_id + ", department_id=" + department_id + ", department_name="
				+ department_name + ", job_title=" + job_title + "]";
	}
