...
public class EmployeeJoinJobVO implements Serializable{
	...
	public EmployeeJoinJobVO() {
		// TODO Auto-generated constructor stub
	}

	public EmployeeJoinJobVO(int employee_id, String first_name, String last_name, String email, String phone_number,
	...
	public int hashCode() {
		return Objects.hash(commission_pct, department_id, email, employee_id, first_name, hire_date, job_id, job_title,
				last_name, manager_id, phone_number, salary);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EmployeeJoinJobVO other = (EmployeeJoinJobVO) obj;
	...
	public String toString() {
		return "EmployeeJoinJobVO [employee_id=" + employee_id + ", first_name=" + first_name + ", last_name="
				...
				+ manager_id + ", department_id=" + department_id + ", job_title=" + job_title + "]";
	}
